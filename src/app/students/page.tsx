              ...
              return (
                ...
                >
                  ...
                  {owned ? (
                    ...
                    <Link
                      href={`${exercise.id === 'cmnyn65sk0001ky049bomjzqw' ? '/english/ex-001' : exercise.id === 'cmnyph3x70001ju04oqbj0zbz' ? '/english/ex-002' : exercise.id === 'cmnzt75kn0001k004ub64r2sv' ? '/danish/ex-001' : exercise.id === 'cmnzw6xpd0007lb04g4t233ez' ? '/multilingual/ex-001' : '/english/ex-001'}`}
